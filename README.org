...
The following Emacs versions are explicitly supported.  NOTE: the
Emacs version shipped in the current Debian stable (since 13 "trixie")
will be supported.

| Version | Notes                                                    |
|---------+----------------------------------------------------------|
|      29 | the current stable version; will be shipped in Debian 13 |
|      30 | the current "testing" version                            |
|      31 | the current development version                          |
